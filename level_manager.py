...
class LevelManager():
    def __init__(self, win, state):
        ...
        self.levels = {1: [300, (1.7, 3.2), [enemy.Slimes, enemy.Wolf], [obstacles.Barricade, obstacles.SpikyRock], enemy.EyeBoss, 330, 80],
                       ...
                       4: [375, (1.2, 2.3), [enemy.Tornado,enemy.Bird], [obstacles.Barricade,obstacles.SpikyRock], enemy.EyeBoss, 2100, 100],
                       5: [395, (2, 2.8), [enemy.Snake,enemy.Octo,enemy.Tornado], [obstacles.Barricade,obstacles.SpikyRock], enemy.SpiderBoss, 2900, 110],
                       6: [395, (2, 2.5), [enemy.Snake,enemy.Octo,enemy.Wolf,enemy.Tornado], [obstacles.Barricade,obstacles.SpikyRock], enemy.MinoBoss, 3750, 120],
                       7: [420, (2, 3), [enemy.Snake,enemy.Wolf,enemy.Tornado,enemy.Bird,enemy.Octo,enemy.Slimes], [obstacles.Barricade,obstacles.SpikyRock], enemy.EyeBoss, 5000, 120]}
